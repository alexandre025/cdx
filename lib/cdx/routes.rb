# Source : https://github.com/spree/spree/blob/master/core/lib/spree/core/routes.rb
...
module Cdx
  class Engine < ::Rails::Engine
    def self.add_routes(&block)
      ...
      @cdx_routes << block unless @cdx_routes.include?(block)
    end
    ...
    def self.draw_routes(&block)
      ...
      @cdx_routes.each { |r| eval_block(&r) }
    ...
    def eval_block(&block)
      Cdx::Engine.routes.send :eval_block, block
    end
  end
end